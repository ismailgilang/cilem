                ...
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto p-6">
                            ...
                            <table class="table-auto w-full border-collapse border border-gray-300 bg-white">
                                <thead class="bg-gray-200">
                                    <tr>
                                        ...
                                        <th rowspan="2" class="border border-gray-300 whitespace-nowrap px-4 py-2">Pilih ( jika sama, tidak usah dipilih )</th>
                                        ...
                                        <th colspan="5" class="border border-gray-300 whitespace-nowrap px-4 py-2">Angsuran Perbulan ( jika sama, tidak usah dipilih )</th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td rowspan="5" class="border border-gray-300 whitespace-nowrap px-4 py-2"><input type="text" id="nama-input" value="{{$item->name}}" class="w-100 px-2 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></td>
                                        <td rowspan="5" class="border border-gray-300 whitespace-nowrap px-4 py-2"><input type="text" id="nik-input" value="{{$item->nik}}" class="w-100 px-2 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></td>
                        ...
                        <div class="flex justify-end mt-4">
                            <form action="{{route('cilem.update', $item->id)}}" method="post" class="w-full">
                                @csrf
                                @method('put')
                                <input type="hidden" value="{{$item->name}}" id="name" name="name">
                                <input type="hidden" value="{{$item->nik}}" id="nik" name="nik">
                                <input type="hidden" value="{{$item->banyak}}" id="banyak" name="banyak">
                                <input type="hidden" value="{{$item->harga_asli}}" id="harga_asli" name="harga_asli">
                                <input type="hidden" value="{{$item->uang_muka}}" id="uang_muka" name="uang_muka">
                                <input type="hidden" value="{{$item->pembiayaan}}" id="pembiayaan" name="pembiayaan">
                                <input type="hidden" value="{{$item->adm}}" id="adm" name="adm">
                                <input type="hidden" value="{{$item->tot_adm}}" id="tot_adm" name="tot_adm">
                                <input type="hidden" value="{{$item->angsuran}}" id="angsuran" name="angsuran">
                                <input type="hidden" value="{{$item->bayar_angsuran}}" id="bayar_angsuran" name="bayar_angsuran">
